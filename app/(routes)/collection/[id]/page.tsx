          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="relative h-96 lg:h-auto">
              ...
              {collection.items.some((item) => item.isNew) && (
                <div className="absolute top-6 left-6">
                  <span className="px-4 py-2 bg-white text-rose-600 rounded-full font-bold text-sm flex items-center gap-2 shadow-lg">
            ...
            <div className="p-8 lg:p-12 flex flex-col justify-center">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full lg:w-auto flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-rose-500 to-orange-500 text-white rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300"
              >
